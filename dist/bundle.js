...
},{"aja":5}],2:[function(require,module,exports){
//ui no jQuery
...
})(window, document, TweenLite);

window.addEventListener('DOMContentLoaded', function(){
  app.ui.init();  
});
},{"./vendor/modernizr.custom.32828.js":3,"./vendor/onwheel.js":4,"aja":5,"cssPlugin":7,"scrollToPlugin":8,"spin.js":9,"tweenLite":6}],3:[function(require,module,exports){
(function (global){
...
; browserify_shim__define__module__export__(typeof modernizer != "undefined" ? modernizer : window.modernizer);
...
; browserify_shim__define__module__export__(typeof onwheel != "undefined" ? onwheel : window.onwheel);
...
; browserify_shim__define__module__export__(typeof TweenLite != "undefined" ? TweenLite : window.TweenLite);
...
(function(name) {
	...
	if (typeof(define) === "function" && define.amd) { //AMD
		...
		__browserify_shim_require__("../TweenLite.js");
		module.exports = getGlobal();
	}
}("CSSPlugin"));

; browserify_shim__define__module__export__(typeof CSSPlugin != "undefined" ? CSSPlugin : window.CSSPlugin);
...
; browserify_shim__define__module__export__(typeof ScrollToPlugin != "undefined" ? ScrollToPlugin : window.ScrollToPlugin);
